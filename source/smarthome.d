...
class SmartHome
{
	string[] getListofDevicesIDs(Session session)
	{
	...
	string getNameOfDevice(Session session, string deviceID)
	{
	...
	bool setSwitchDevice(Session session, string deviceID, bool power)
	{
	...
	bool toggleSwitchDevice(Session session, string deviceID)
	{
